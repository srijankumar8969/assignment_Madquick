...
export default function VaultPage() {
    ...
    if (status === "loading" || isLoading) {
        return (
            <div
                className={`min-h-screen flex items-center justify-center transition-colors duration-500 ${isDark
    ...
    return (
        <div
            className={`min-h-screen p-4 md:p-8 transition-colors duration-500 ${isDark
        ...
        >
            <div className="max-w-4xl mx-auto">
                {/* Header */}
                <div
                    className={`rounded-xl shadow-lg p-6 mb-6 transition-colors duration-500 ${isDark ? "bg-black text-gray-100" : "bg-white text-gray-900"
                        }`}
                >
                ...
                {/* Search & Items List */}
                <div
                    className={`rounded-xl shadow-lg p-4 mb-6 transition-colors duration-500 ${isDark ? "bg-black text-gray-100" : "bg-white text-gray-900"
                        }`}
                >
                    <input
                        type="text"
                ...
                <div className="space-y-4">
                    {filtered.length === 0 ? (
                        <div
                            className={`rounded-xl shadow-lg p-12 text-center transition-colors duration-500 ${isDark ? "bg-black text-gray-400" : "bg-white text-gray-500"
                                }`}
                        >
                            <p className="text-lg">
                        ...
                        filtered.map(item => (
                            <div
                                key={item._id}
                                className={`rounded-xl shadow-lg p-6 hover:shadow-xl transition-colors duration-500 ${isDark ? "bg-black text-gray-100" : "bg-white text-gray-900"
                                    }`}
                            >
